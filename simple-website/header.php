...
<html>
    <head>
        <title><?php echo stripslashes($pageDetails["page_title"]); ?> - <?php echo SITE_NAME; ?> www.saveetha.ac.in</title>
                ...
                <div class="row">
                    <div class="12u">
                        <header id="header">
                            ...
                            <nav id="nav">
							    <a href="TodaysPost.php" <?php echo ($currentPage == "TodaysPost") ? ' class="current-page-item"' : '' ?> >TodaysPost</a>
                              ...
                              <!--  <a href="category.php" <?php echo ($currentPage == "category") ? ' class="current-page-item"' : '' ?>>Category</a>
							   ...
							   <a href="verfiy.php" target="_blank">Admin access</a>
                            </nav>
                        </header>
